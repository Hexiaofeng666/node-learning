...
app.post('/querstion/answer', (req, res) => {
            console.log(req.headers.cookies.split('on=')[1]);
            const my_cookie = req.headers.cookie.split(';')
            const querstion = req.headers.cookies.split('on=')[2]
            // 获取问题路径
